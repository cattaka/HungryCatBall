...
public class SoftblockEntity extends BlockEntity {
    private static final Vec2 SIZE = new Vec2(CELL_SIZE * 2 - CELL_MARGIN, CELL_SIZE * 1 - CELL_MARGIN);
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_SOFTBLOCK);
        mPieceClass = SoftblockPieceEntity.class;
