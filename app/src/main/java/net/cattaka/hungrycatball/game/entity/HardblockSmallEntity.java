...
public class HardblockSmallEntity extends BlockEntity {
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_HARDBLOCK_SMALL);
        mPieceClass = HardblockSmallPieceEntity.class;
        mMaxHealth = HEALTH_HARDBLOCK;
        mSize = SIZE;
