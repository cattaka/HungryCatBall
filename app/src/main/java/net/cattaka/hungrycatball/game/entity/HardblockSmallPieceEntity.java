...
public class HardblockSmallPieceEntity extends BlockPieceEntity {
    ...
    public HardblockSmallPieceEntity() {
        super();
    }
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_HARDBLOCK_SMALL_PIECE);
