...
public class SoftblockSmallPieceEntity extends BlockPieceEntity {
    ...
    public SoftblockSmallPieceEntity() {
        super();
    }
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_SOFTBLOCK_SMALL_PIECE);
        //mPieceClass = SoftblockPieceEntity.class;
        mMaxHealth = HEALTH_SOFTBLOCK / 4f;
        mSize = SIZE;
