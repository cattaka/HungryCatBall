...
public class SoftblockSmallEntity extends BlockEntity {
    private static final Vec2 SIZE = new Vec2(CELL_SIZE * 1 - CELL_MARGIN, CELL_SIZE * 1 - CELL_MARGIN);
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_SOFTBLOCK_SMALL);
        mPieceClass = SoftblockSmallPieceEntity.class;
        mMaxHealth = HEALTH_SOFTBLOCK;
        mSize = SIZE;
