...
public class SoftblockPieceEntity extends BlockPieceEntity {
    ...
    public void initializeEx(GameWorld gameWorld, SceneBundle sceneBundle, Object exData) {
        mImageResource = sceneBundle.getDrawUtil().getImageResource(TextureId.ENTITY_SOFTBLOCK_PIECE);
