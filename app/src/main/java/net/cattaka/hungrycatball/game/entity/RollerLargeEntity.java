...
public class RollerLargeEntity extends PhysicalEntity {
    private static final Vec2 BLOCK_SIZE = new Vec2(4, 4);
    private static BodyDef[] BODY_DEFS;
    private static ShapeDef[] SHAPE_DEFS;

    static {
        CircleDef cd = new CircleDef();
        cd.radius = 2.0f - CELL_MARGIN;
        cd.density = 2.0f;
        cd.friction = 0.5f;
